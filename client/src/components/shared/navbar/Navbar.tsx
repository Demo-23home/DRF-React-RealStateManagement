...
export default function Navbar() {
	return (
		<nav
			className='flex-between bg-baby_rich dark:shadow-none"> <Link href="/" className="flex border-b-platinum shadow-platinum fixed z-50 w-full items-center gap-5 border-b-2
			p-4 sm:p-6 lg:px-12 dark:border-b-0'
		>
