...
function LeftNavbar() {
	...
	return (
		<section className="bg-baby_rich light-border custom-scrollbar sticky left-0 top-0 flex h-screen flex-col justify-between overflow-y-auto border-r p-6 pt-36 shadow-platinum dark:shadow-none max-sm:hidden lg:w-[297px]">
