		...
		<div className="relative h-screen">
			...
			<main className="flex-center relative z-10 h-full bg-black/50">
				<div className="text-center">
					<h1 className="mb-4 font-robotoSlab text-4xl font-semibold text-cyan-400 antialiased sm:text-6xl md:text-8xl">
					...
					<Link href="/register" prefetch={false}>
						<button className="rounded-3xl bg-asparagus px-4 py-2 text-lg font-semibold text-white hover:bg-lime-700 sm:px-6 sm:text-2xl">
